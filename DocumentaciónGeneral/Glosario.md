...
Centraliza las siglas y términos utilizados en el repositorio para evitar ambigüedades.
...
| Sigla | Significado |
| ----- | ----------- |
| DOC | Documentación del Repositorio |
| CFG | Configuración Técnica del Repositorio |
| RDJ | Reglas de Juego |
...
| Repositorio | Espacio donde se almacenan y versionan los Ítems de Configuración del grupo. |
| Commit | Registro de uno o más cambios realizados sobre el repositorio, con su autor, fecha y mensaje descriptivo. |
| Tag | Etiqueta utilizada para identificar un estado específico del repositorio. En este proyecto se utiliza para marcar Líneas Base. |
| Trazabilidad | Capacidad de seguir la evolución de un ítem a lo largo del tiempo y de vincularlo con las versiones anteriores y posteriores. |
